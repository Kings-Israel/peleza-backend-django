...
DEBUG = True
# <<<<<<< HEAD
ALLOWED_HOSTS = ["kyc.pidva.africa", "localhost", "localhost:3001", "192.168.*", "pidva.africa", "localhost:3000", "127.0.0.1","stanbic.pidva.africa"]
...
INTERNAL_IPS = ["127.0.0.1", "localhost", "192.168.1.210"]
MIDDLEWARE = [
