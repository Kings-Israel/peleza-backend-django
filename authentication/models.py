...
class PelClient(models.Model):
    ...
    @classmethod
    def register(cls, first_name, last_name, country, parent_company, industry, email, mobile_phone, password, postal_address=None, postal_code=None, postal_city=None, **kwargs):
        user = None
        # password = hashlib.md5(password.encode()).hexdigest()

        try:
            user = cls.objects.create(
                client_company_id = parent_company,
                client_login_username = email,
                client_password = hashlib.md5(password),
                client_first_name = first_name,
                client_last_name = last_name,
                client_mobile_number = mobile_phone,
                client_postal_address = postal_address,
                client_postal_code = postal_code,
                client_city = postal_city,
                client_parent_company = parent_company,
